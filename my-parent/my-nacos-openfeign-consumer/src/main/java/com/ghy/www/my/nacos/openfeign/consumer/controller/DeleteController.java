...
import com.ghy.www.my.nacos.openfeign.consumer.openfeignclient.DeleteControllerClient;
...
public class DeleteController {
    ...
    @Autowired
    private DeleteControllerClient deleteControllerClient;

    @RequestMapping("test1")
    public String test1(HttpServletRequest request, HttpServletResponse response) {
        ResponseBox<String> box = deleteControllerClient.test1(request, response);
    ...
    public String test2() throws UnsupportedEncodingException {
        ...
        ResponseBox<String> box = deleteControllerClient.test2(id, username, password, age, insertdate);
        System.out.println("getData=" + box.getData());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
        return "返回值";
    ...
    public String test3() throws UnsupportedEncodingException {
        ...
        ResponseBox<String> box = deleteControllerClient.test3(id, username, password, age, insertdate);
        System.out.println("getData=" + box.getData());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
        return "返回值";
    ...
    public String test4() throws UnsupportedEncodingException {
        ...
        ResponseBox<UserinfoDTO2> box = deleteControllerClient.test4(id, username, password, age, insertdate);
    ...
    public String test5() throws UnsupportedEncodingException {
        ...
        ResponseBox<UserinfoDTO2> box = deleteControllerClient.test5(userinfoDTO2Param);
        UserinfoDTO2 userinfoDTO2 = box.getData();
        System.out.println(userinfoDTO2.getId() + " " + userinfoDTO2.getUsername() + " " + userinfoDTO2.getPassword() + " " + userinfoDTO2.getAge() + " " + userinfoDTO2.getInsertdate());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
    ...
    public String test6() throws UnsupportedEncodingException {
        ...
        ResponseBox<UserinfoDTO2> box = deleteControllerClient.test6(userinfoDTO2Param);
        UserinfoDTO2 userinfoDTO2 = box.getData();
        System.out.println(userinfoDTO2.getId() + " " + userinfoDTO2.getUsername() + " " + userinfoDTO2.getPassword() + " " + userinfoDTO2.getAge() + " " + userinfoDTO2.getInsertdate());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
