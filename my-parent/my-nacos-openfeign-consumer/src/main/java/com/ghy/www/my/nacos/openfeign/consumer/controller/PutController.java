...
import com.ghy.www.my.nacos.openfeign.consumer.openfeignclient.PutControllerClient;
...
public class PutController {
    ...
    @Autowired
    private PutControllerClient putControllerClient;

    @RequestMapping("test1")
    public String test1(HttpServletRequest request, HttpServletResponse response) {
        ResponseBox<String> box = putControllerClient.test1(request, response);
    ...
    public String test2() throws UnsupportedEncodingException {
        ...
        ResponseBox<String> box = putControllerClient.test2(id, username, password, age, insertdate);
        System.out.println("getData=" + box.getData());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
        return "返回值";
    ...
    public String test3() throws UnsupportedEncodingException {
        ...
        String age = "100";
        String insertdate = "2000-01-01";
        ResponseBox<String> box = putControllerClient.test3(id, username, password, age, insertdate);
        System.out.println("getData=" + box.getData());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
        return "返回值";
    ...
    public String test4() throws UnsupportedEncodingException {
        ...
        ResponseBox<UserinfoDTO2> box = putControllerClient.test4(id, username, password, age, insertdate);
    ...
    public String test5() throws UnsupportedEncodingException {
        ...
        ResponseBox<UserinfoDTO2> box = putControllerClient.test5(userinfoDTO2Param);
        UserinfoDTO2 userinfoDTO2 = box.getData();
        System.out.println(userinfoDTO2.getId() + " " + userinfoDTO2.getUsername() + " " + userinfoDTO2.getPassword() + " " + userinfoDTO2.getAge() + " " + userinfoDTO2.getInsertdate());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
    ...
    public String test6() throws UnsupportedEncodingException {
        ...
        ResponseBox<UserinfoDTO2> box = putControllerClient.test6(userinfoDTO2Param);
        UserinfoDTO2 userinfoDTO2 = box.getData();
        System.out.println(userinfoDTO2.getId() + " " + userinfoDTO2.getUsername() + " " + userinfoDTO2.getPassword() + " " + userinfoDTO2.getAge() + " " + userinfoDTO2.getInsertdate());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
