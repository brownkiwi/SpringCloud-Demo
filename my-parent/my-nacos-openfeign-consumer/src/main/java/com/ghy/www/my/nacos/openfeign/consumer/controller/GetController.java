...
import com.ghy.www.my.nacos.openfeign.consumer.openfeignclient.GetControllerClient;
...
public class GetController {
    ...
    public String test2() throws UnsupportedEncodingException {
        ...
        ResponseBox<String> box = getControllerClient.test2(id, username, password, age, insertdate);
        System.out.println("getData=" + box.getData());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
        return "返回值";
    ...
    public String test3() throws UnsupportedEncodingException {
        ...
        String age = "100";
        String insertdate = "2000-01-01";
        ResponseBox<String> box = getControllerClient.test3(id, username, password, age, insertdate);
        System.out.println("getData=" + box.getData());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
        return "返回值";
    ...
    public String test4() throws UnsupportedEncodingException {
        ...
        ResponseBox<UserinfoDTO2> box = getControllerClient.test4(id, username, password, age, insertdate);
    ...
    // provider:org.springframework.web.HttpRequestMethodNotSupportedException: Request method 'POST' not supported
    // consumer:Method Not Allowed
    ...
    public String test5() throws UnsupportedEncodingException {
        ...
        ResponseBox<UserinfoDTO2> box = getControllerClient.test5(userinfoDTO2Param);
        UserinfoDTO2 userinfoDTO2 = box.getData();
        System.out.println(userinfoDTO2.getId() + " " + userinfoDTO2.getUsername() + " " + userinfoDTO2.getPassword() + " " + userinfoDTO2.getAge() + " " + userinfoDTO2.getInsertdate());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
    ...
    public String test6() throws UnsupportedEncodingException {
        ...
        ResponseBox<UserinfoDTO2> box = getControllerClient.test6(userinfoDTO2Param);
        UserinfoDTO2 userinfoDTO2 = box.getData();
        System.out.println(userinfoDTO2.getId() + " " + userinfoDTO2.getUsername() + " " + userinfoDTO2.getPassword() + " " + userinfoDTO2.getAge() + " " + userinfoDTO2.getInsertdate());
        System.out.println("getMessage=" + box.getMessage());
        System.out.println("getResponseCode=" + box.getResponseCode());
