package com.ghy.www.my.nacos.namespace.consumer.controller;
...
public class TestController {
    ...
    public void Test1(HttpServletRequest request, HttpServletResponse response) {
        ...
        ResponseEntity<ResponseBox<UserinfoDTO2>> responseEntity = restTemplate.exchange("http://my-nacos-namespace-provider-8085/Test1?id=" + id + "&username=" + username + "&password=" + password + "&age=" + age + "&insertdate=" + insertdate, HttpMethod.GET, null, new ParameterizedTypeReference<ResponseBox<UserinfoDTO2>>() {
        });
