...
public class Test6 {
    public static void main(String[] args) throws JsonProcessingException {
        ...
        ResponseEntity<ResponseBox<UserinfoDTO2>> responseEntity = template.exchange("http://localhost:8080/delete/test6", HttpMethod.DELETE, entity, new ParameterizedTypeReference<ResponseBox<UserinfoDTO2>>() {
        });
