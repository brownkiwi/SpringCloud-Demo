...
public class Test5 {
    public static void main(String[] args) {
        ...
        ResponseEntity<ResponseBox<UserinfoDTO2>> responseEntity = template.exchange("http://localhost:8080/delete/test5", HttpMethod.DELETE, entity, new ParameterizedTypeReference<ResponseBox<UserinfoDTO2>>() {
        });
