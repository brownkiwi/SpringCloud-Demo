...
public class Test3 {
    public static void main(String[] args) {
        ...
        ResponseEntity<ResponseBox<String>> responseEntity = template.exchange("http://localhost:8080/get/test3/id/{id}/username/{username}/password/{password}/age/{age}/insertdate/{insertdate}", HttpMethod.GET, null, new ParameterizedTypeReference<ResponseBox<String>>() {
