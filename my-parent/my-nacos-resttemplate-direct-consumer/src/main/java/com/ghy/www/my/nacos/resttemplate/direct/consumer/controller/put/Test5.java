...
public class Test5 {
    public static void main(String[] args) {
        ...
        ResponseEntity<ResponseBox<UserinfoDTO2>> responseEntity = template.exchange("http://localhost:8080/put/test5", HttpMethod.PUT, entity, new ParameterizedTypeReference<ResponseBox<UserinfoDTO2>>() {
        });
