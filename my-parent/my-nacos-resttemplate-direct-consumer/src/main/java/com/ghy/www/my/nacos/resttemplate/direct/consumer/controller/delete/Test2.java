...
public class Test2 {
    public static void main(String[] args) throws JsonProcessingException {
        ...
        ResponseEntity<ResponseBox<String>> responseEntity = template.exchange(URI.create("http://localhost:8080/delete/test2"), HttpMethod.DELETE, entity, new ParameterizedTypeReference<ResponseBox<String>>() {
        });
