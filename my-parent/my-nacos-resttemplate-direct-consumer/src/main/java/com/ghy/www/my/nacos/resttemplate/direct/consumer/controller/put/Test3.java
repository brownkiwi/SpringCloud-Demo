...
public class Test3 {
    public static void main(String[] args) {
        ...
        ResponseEntity<ResponseBox<String>> responseEntity = template.exchange("http://localhost:8080/put/test3/id/{id}/username/{username}/password/{password}/age/{age}/insertdate/{insertdate}", HttpMethod.PUT, null, new ParameterizedTypeReference<ResponseBox<String>>() {
