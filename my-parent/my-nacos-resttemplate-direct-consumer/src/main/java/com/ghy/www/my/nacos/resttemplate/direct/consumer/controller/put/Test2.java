...
public class Test2 {
    public static void main(String[] args) throws JsonProcessingException {
        ...
        ResponseEntity<ResponseBox<String>> responseEntity = template.exchange(URI.create("http://localhost:8080/put/test2"), HttpMethod.PUT, entity, new ParameterizedTypeReference<ResponseBox<String>>() {
        });
