...
public class Test1 {
    public static void main(String[] args) {
        ...
        ResponseEntity<ResponseBox<String>> responseEntity = template.exchange(URI.create("http://localhost:8080/put/test1"), HttpMethod.PUT, null, new ParameterizedTypeReference<ResponseBox<String>>() {
        });
