...
public class Test4 {
    public static void main(String[] args) {
        ...
        ResponseEntity<ResponseBox<UserinfoDTO2>> responseEntity = template.exchange("http://localhost:8080/delete/test4", HttpMethod.DELETE, entity, new ParameterizedTypeReference<ResponseBox<UserinfoDTO2>>() {
        });
