...
public class TestController3 {
    ...
    public void get_test5_2(HttpServletRequest request, HttpServletResponse response) {
        ...
        ResponseEntity<ResponseBox<UserinfoDTO2>> responseEntity = restTemplate.exchange("http://my-nacos-provider-cluster/get/test5?id=" + id + "&username=" + username + "&password=" + password + "&age=" + age + "&insertdate=" + insertdate, HttpMethod.GET, null, new ParameterizedTypeReference<ResponseBox<UserinfoDTO2>>() {
        });
    ...
    public void post_test5_2(HttpServletRequest request, HttpServletResponse response) {
        ...
        ResponseEntity<ResponseBox<UserinfoDTO2>> responseEntity = restTemplate.exchange("http://my-nacos-provider-cluster/post/test5", HttpMethod.POST, entity, new ParameterizedTypeReference<ResponseBox<UserinfoDTO2>>() {
        });
        ResponseBox<UserinfoDTO2> box = responseEntity.getBody();
        UserinfoDTO2 userinfoDTO2 = box.getData();
        System.out.println(box.getResponseCode() + " " + userinfoDTO2.getId() + " " + userinfoDTO2.getUsername() + " " + userinfoDTO2.getPassword() + " " + userinfoDTO2.getAge() + " " + userinfoDTO2.getInsertdate() + " " + box.getMessage());
    }
    @GetMapping("/put/test5")
    public void put_test5_2(HttpServletRequest request, HttpServletResponse response) {
        ...
        ResponseEntity<ResponseBox<UserinfoDTO2>> responseEntity = restTemplate.exchange("http://my-nacos-provider-cluster/put/test5", HttpMethod.PUT, entity, new ParameterizedTypeReference<ResponseBox<UserinfoDTO2>>() {
        });
        ResponseBox<UserinfoDTO2> box = responseEntity.getBody();
        UserinfoDTO2 userinfoDTO2 = box.getData();
        System.out.println(box.getResponseCode() + " " + userinfoDTO2.getId() + " " + userinfoDTO2.getUsername() + " " + userinfoDTO2.getPassword() + " " + userinfoDTO2.getAge() + " " + userinfoDTO2.getInsertdate() + " " + box.getMessage());
    ...
    public void delete_test5_2(HttpServletRequest request, HttpServletResponse response) {
        ...
        ResponseEntity<ResponseBox<UserinfoDTO2>> responseEntity = restTemplate.exchange("http://my-nacos-provider-cluster/delete/test5", HttpMethod.DELETE, entity, new ParameterizedTypeReference<ResponseBox<UserinfoDTO2>>() {
        });
        ResponseBox<UserinfoDTO2> box = responseEntity.getBody();
        UserinfoDTO2 userinfoDTO2 = box.getData();
        System.out.println(box.getResponseCode() + " " + userinfoDTO2.getId() + " " + userinfoDTO2.getUsername() + " " + userinfoDTO2.getPassword() + " " + userinfoDTO2.getAge() + " " + userinfoDTO2.getInsertdate() + " " + box.getMessage());
